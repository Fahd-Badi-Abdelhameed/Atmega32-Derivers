...
static void(*TIMER0_OC0_CallBack)(void) = NULL;
...
void TIMER0_voidOC0_InterruptEnable(void){
...
void TIMER0_voidOC0_InterruptDisable(void){
...
void TIMER0_voidOC0_SetCallBack(void(*Local_Fptr)(void)){

	TIMER0_OC0_CallBack = Local_Fptr;
